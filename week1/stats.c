...
void print_array(unsigned char* a_arr, unsigned char a_arr_length )
{
	...
	unsigned char i;
	/*print the bracket as start of the data*/
	printf("[");
	...
	/*print the close bracket as end of the data and go to new line*/
	printf("]\n");
}
...
{
	unsigned long long int  sum; /* the sum of the array will be saved in this variable*/
